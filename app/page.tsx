      ...
      <main className='bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans min-h-screen transition-colors duration-300'>
        ...
        <div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8'>
          ...
          <div className='mb-6 sm:mb-8'>
            <div className='bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6'>
          ...
          {/* Main content grid - Better balanced layout */}
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6'>
            {/* Left Column - Add New Expense */}
            ...
            {/* Right Column - History and AI Insights */}
            <div className='lg:col-span-1 space-y-4 sm:space-y-6'>
              <RecordHistory />
              <AIInsights />
            </div>
